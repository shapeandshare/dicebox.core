...
class DiceboxConfigTest(unittest.TestCase):
    ...
    def test_config_over_one(self):
        ...
        # composite
        self.assertEqual(
            dc.SENSORY_SERVICE_RABBITMQ_URL, "amqpz://sensory_service1:sensory_service!1231@localhost1:56711/sensory1"
        )
        ...
        # composite
        self.assertEqual(
            dc.TRAINING_SERVICE_RABBITMQ_URL,
        ...
        self.assertEqual(dc.TRAINING_PROCESSOR_SERVICE_RABBITMQ_TRAIN_REQUEST_TASK_QUEUE, "train.request.task.queue2")
        ...
        # composite
        self.assertEqual(
            dc.TRAINING_PROCESSOR_SERVICE_RABBITMQ_URL,
