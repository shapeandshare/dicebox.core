...
class BaseConfigTest(unittest.TestCase):
    ...
    def test_config(self):
        ...
        # composite
        self.assertEqual(
            self.dc.SENSORY_SERVICE_RABBITMQ_URL, "amqps://sensory_service:sensory_service!123@localhost:5671/sensory"
        )
        ...
        # composite
        self.assertEqual(
            self.dc.TRAINING_SERVICE_RABBITMQ_URL,
        ...
        self.assertEqual(
            self.dc.TRAINING_PROCESSOR_SERVICE_RABBITMQ_TRAIN_REQUEST_TASK_QUEUE, "train.request.task.queue"
        )
        ...
        # composite
        self.assertEqual(
            self.dc.TRAINING_PROCESSOR_SERVICE_RABBITMQ_URL,
