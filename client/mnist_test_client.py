...
import numpy
import math
from lib import mnist_config as config  # import our high level configuration
...
for item in network_input_index:
    ...
    try:
        ...
        response = requests.post('http://172.16.0.79:5001/api/prediction', data=json_data, headers=headers)
        #response = requests.post('http://127.0.0.1:5001/api/prediction', data=json_data, headers=headers)
